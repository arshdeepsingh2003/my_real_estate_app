...
export default function Home() {
  ...
  useEffect(() => {
    const fetchOfferListings = async () => {
      try {
        const res = await fetch('https://my-real-estate-app-pyjg.vercel.app/api/listing/get?offer=true&limit=4');
    ...
    const fetchRentListings = async () => {
      try {
        const res = await fetch('https://my-real-estate-app-pyjg.vercel.app/api/listing/get?type=rent&limit=4');
        const data = await res.json();
    ...
    const fetchSaleListings = async () => {
      try {
        const res = await fetch('https://my-real-estate-app-pyjg.vercel.app/api/listing/get?type=sale&limit=4');
        const data = await res.json();
