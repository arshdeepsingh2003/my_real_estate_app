...
export default function Profile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`https://my-real-estate-app-pyjg.vercel.app/api/user/update/${currentUser._id}`, {
        method: 'POST',
        headers: {
  ...
  const handleDeleteUser = async () => {
    try {
      ...
      const res = await fetch(`https://my-real-estate-app-pyjg.vercel.app/api/user/delete/${currentUser._id}`, {
        method: 'DELETE',
      });
      const data = await res.json();
      if (data.success === false) {
  ...
  const handleSignOut = async () => {
    try {
      ...
      const res = await fetch('https://my-real-estate-app-pyjg.vercel.app/api/auth/signout');
      const data = await res.json();
      if (data.success === false) {
        dispatch(deleteUserFailure(data.message));
        return;
  ...
  const handleShowListings = async () => {
    try {
      ...
      const res = await fetch(`https://my-real-estate-app-pyjg.vercel.app/api/user/listings/${currentUser._id}`);
      const data = await res.json();
      if (data.success === false) {
  ...
  const handleListingDelete = async (listingId) => {
    try {
      const res = await fetch(`https://my-real-estate-app-pyjg.vercel.app/api/listing/delete/${listingId}`, {
        method: 'DELETE',
      });
      const data = await res.json();
      if (data.success === false) {
